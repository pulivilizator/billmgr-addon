...
class MgrAddonExtension:
    ...
    def init_app(self, app: Flask, endpoints):
        ...
        logging.debug(f'MgrAddonExtension extension initialized with "{MgrAddonExtension.namespace_id}" namespace')
    ...
    def on_extension_close(self):
        ...
        logging.debug(f'MgrAddonExtension extension with "{MgrAddonExtension.namespace_id}" namespace is closed')
