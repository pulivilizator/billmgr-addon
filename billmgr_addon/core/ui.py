...
class MgrForm(MgrUI):
    ...
    def add_text_field(self, name: str, label: str = None, value: str = None, required: bool = False):
    ...
    def add_select_field(self, name: str, options: List[Dict], label: str = None, value: str = None):
        """Добавить поле выбора"""
        field_elem = self.add_field(
            name=name,
            field_type="select",
            label=label,
            value=value
    ...
    def add_checkbox_field(self, name: str, label: str = None, checked: bool = False):
        ...
        return self.add_field(
            ...
            field_type="checkbox",
            label=label,
            checked="yes" if checked else None
        )
