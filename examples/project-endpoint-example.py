...
from billmgr_addon.core.router import FormEndpoint, ListEndpoint, MgrEndpoint, MgrRequest
...
class HostingAccountMixin:
    ...
    def _get_hosting_account(self, user_id):
        ...
        return {"item_id": 123, "account_id": "acc_456", "domain": "example.com", "quota": 1000}
