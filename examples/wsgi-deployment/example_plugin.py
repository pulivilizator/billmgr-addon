...
from billmgr_addon.core.router import ListEndpoint, FormEndpoint, ActionEndpoint
from billmgr_addon.core.ui import MgrList, MgrForm
from billmgr_addon.core.request_types import MgrRequest
from billmgr_addon.core.response import MgrSuccessResponse, MgrErrorResponse
...
class ServerForm(FormEndpoint):
    ...
    async def get(self, form: MgrForm, mgr_request: MgrRequest):
        ...
        form.add_select_field("cpu", options=[
            {"value": 1, "label": "1 CPU"},
            {"value": 2, "label": "2 CPU"},
            {"value": 4, "label": "4 CPU"},
            {"value": 8, "label": "8 CPU"}
        ])
        form.add_select_field("ram", options=[
